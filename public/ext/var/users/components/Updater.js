...
Extriajs.users.components.Updater = Ext.extend(Ext.FormPanel,{
	initComponent: function(){
		...
		*/
        ...
        Extriajs.users.components.Updater.superclass.initComponent.apply(this);
	...
	_submit: function(){
		...
		if(me.ownerCt.operation == "add"){
			...
			var url = '/api/users/' + me.ownerCt.app_id + '.json';
			var method = 'PUT';
		}
		me.mask.show();
		me.getForm().submit({
...
Ext.reg('extria-users-updater', Extriajs.users.components.Updater);